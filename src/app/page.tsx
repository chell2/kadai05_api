  ...
  return (
    <div className="bg-white text-primary min-h-screen">
      <header className="bg-secondary p-4">
        <h1 className="text-neutral text-xl">Welcome to the Dashboard</h1>
      </header>
      ...
      <main className="p-8">
        ...
        <div className="mt-4 p-6 bg-accent rounded text-neutral">
          <p>This is an alert or important message area.</p>
        </div>
      </main>
    </div>
  );
